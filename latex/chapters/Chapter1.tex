...
Phần còn lại của báo cáo được tổ chức như sau. Chương \ref{chap:background} trình bày cơ sở lý thuyết, bao gồm phát biểu bài toán, các loại tấn công, các tập dữ liệu benchmark, các nhóm kiến trúc tiếp cận và phương pháp đánh giá. Chương \ref{chap:experiment} mô tả thiết lập thí nghiệm, trình bày kết quả EER tổng hợp trên năm mô hình trong benchmark chính và bốn dataset, phân tích lỗi trên ASVspoof 5, đồng thời giải thích trường hợp checkpoint AASIST3 bị loại khỏi phân tích chính. Chương \ref{chap:conclusion} tổng kết các phát hiện chính, đưa ra đề xuất hướng tiếp cận ở mức ý niệm và các bước phát triển tiếp theo trong khuôn khổ Thực tập 2 và Luận văn.
