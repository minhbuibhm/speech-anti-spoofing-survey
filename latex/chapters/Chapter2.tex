...
Bảng \ref{tab:reproduced-models} tổng hợp sáu mô hình được reproduce trong Chương \ref{chap:experiment}. Các giá trị hiệu năng trong cột ``Kết quả paper'' chỉ để đặt mô hình vào bối cảnh, không dùng thay cho kết quả reproduce. Các metric khác loại như EER, min t-DCF và minDCF không được so sánh trực tiếp với nhau.
...
\begin{table}[H]
    ...
    \begin{tabular}{p{2.5cm}|p{2.7cm}|p{2.6cm}|p{2.4cm}|p{3.7cm}|p{3.7cm}|p{3.5cm}}
        ...
        \\ \hline
        AASIST3 & Wav2Vec2 SSL features & KAN bridge + modified AASIST & Hàng trăm triệu params nếu tính SSL & Đại diện checkpoint ASVspoof 2024-context dùng SSL + KAN & Metric paper là minDCF trong challenge condition; không nên gọi SOTA rộng & ASVspoof 2024: minDCF 0.5357 closed, 0.1414 open \cite{aasist3}
        \\ \hline
